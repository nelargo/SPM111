...
public class FormContrato extends Activity implements View.OnClickListener {
    ImageButton btn_back, btn_save;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.frag_form_contrato);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.ib_save) {
            startActivity(new Intent(this, FormCuenta.class));
        }
    }
}
